...
class MedicineController extends Controller
{
 /**
    ...
    public function index()
    {
        ...
        return view('medicine/medicinesView', compact('medicines'));
    }
    ...
    public function create()
    {
        ...
        return view('medicine/medicineFormView', compact('medicine', 'action','images'));
    }
    ...
    {
        return view('medicine/medicineDetailsView', compact('medicine'));
    }
    ...
    public function edit(Medicine $medicine)
    {
        ...
        return view('medicine/medicineFormView', compact('medicine', 'action'));
    }
